...
public class ChooseServiceImpl implements ChooseService {
	...
	public ChooseDataAll getData() {
		...
		double like = otherdata.getOlike();
		double unlike = otherdata.getOunlike();
		double total = like + unlike;
		...
		chooseDataAll.setOlike(otherdata.getOlike());
		chooseDataAll.setOunlike(otherdata.getOunlike());
